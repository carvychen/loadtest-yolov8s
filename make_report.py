...
bullet(doc, "RTX(NC24)单位成本约为 T4 的 68%、A10 的 41%(即比 T4 省约 32%、比 A10 省约 59%)。")
...
para(doc,
     "A10 单机绝对吞吐最高(362 QPS),但单价 $3.20/hr 偏贵,单位推理成本最高;T4 单机吞吐最低。"
...
make_table(doc,
    ...
    [["NC24lds_xl_RTXPRO6000BSE_v6", "1.01", "36.3", "1.00×(基准)"],
     ...
     ["NC16as_T4_v3", "1.48", "53.1", "1.46×"],
     ["NV36ads_A10_v5", "2.45", "88.3", "2.43×"]],
...
bullet(doc, "价格为 Azure 公开零售价(Consumption / 按需 / Linux / 非 Spot,查询于 2026-09),三卡统一取 West US 2 区域以保证口径一致(吞吐为硬件绑定,与区域无关);如有 EA/预留折扣或换区,按实际单价折算即可,不影响相对结论。", size=9.5)
